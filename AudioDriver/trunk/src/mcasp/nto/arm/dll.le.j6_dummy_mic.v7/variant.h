...
#define TX_SERIALIZER        1

#define CODEC_SLAVE_ADDR1      0x60
#ifdef STREAM_CONTROL
#define MUTE_ADDR              0xF2433BUL//primary mute address define  use by mcasp_dll.c
#endif
 ...
 * the definitions here
 */
#define MCASP0_TX_IRQ        (156 + 32)
#define MCASP0_RX_IRQ        (155 + 32)
